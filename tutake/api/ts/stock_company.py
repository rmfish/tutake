...
from tutake.api.ts import stock_company_ext
...
class TushareStockCompany(TutakeTableBase):
...
class StockCompany(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareStockCompany),
...
extends_attr(StockCompany, stock_company_ext)
