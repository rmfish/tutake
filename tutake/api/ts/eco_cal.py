...
from tutake.api.ts import eco_cal_ext
...
class TushareEcoCal(TutakeTableBase):
...
class EcoCal(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareEcoCal),
...
extends_attr(EcoCal, eco_cal_ext)
