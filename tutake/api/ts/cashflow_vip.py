...
from tutake.api.ts import cashflow_vip_ext
...
class TushareCashflowVip(TutakeTableBase):
    ...
    def fetch_and_append(self, **kwargs):
        ...
        def fetch_save(offset_val=0):
            try:
                ...
                return self.tushare_query('cashflow_vip', fields=self.tushare_fields, **kwargs)
...
extends_attr(CashflowVip, cashflow_vip_ext)
