...
from tutake.api.ts import fund_daily_ext
...
class FundDaily(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareFundDaily),
...
extends_attr(FundDaily, fund_daily_ext)
