...
from tutake.api.ts import stk_limit_ext
...
class TushareStkLimit(TutakeTableBase):
...
class StkLimit(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareStkLimit),
...
extends_attr(StkLimit, stk_limit_ext)
