...
from tutake.api.ts import index_global_ext
...
class IndexGlobal(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareIndexGlobal),
...
extends_attr(IndexGlobal, index_global_ext)
