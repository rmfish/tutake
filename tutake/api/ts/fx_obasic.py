...
from tutake.api.ts.fx_obasic_ext import *
...
class FxObasic(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.schema = BaseDao.parquet_schema(TushareFxObasic)
...
setattr(FxObasic, 'default_limit', default_limit_ext)
setattr(FxObasic, 'default_cron_express', default_cron_express_ext)
setattr(FxObasic, 'default_order_by', default_order_by_ext)
setattr(FxObasic, 'prepare', prepare_ext)
setattr(FxObasic, 'query_parameters', query_parameters_ext)
setattr(FxObasic, 'param_loop_process', param_loop_process_ext)
