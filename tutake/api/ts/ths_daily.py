...
from tutake.api.ts import ths_daily_ext
...
class TushareThsDaily(TutakeTableBase):
...
class ThsDaily(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareThsDaily),
    ...
    def fetch_and_append(self, **kwargs):
        ...
        def fetch_save(offset_val=0):
            try:
                ...
                return self.tushare_query('ths_daily', fields=self.tushare_fields, **kwargs)
...
extends_attr(ThsDaily, ths_daily_ext)
