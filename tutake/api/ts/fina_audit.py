...
from tutake.api.ts.fina_audit_ext import *
...
setattr(FinaAudit, 'default_limit', default_limit_ext)
setattr(FinaAudit, 'default_cron_express', default_cron_express_ext)
setattr(FinaAudit, 'default_order_by', default_order_by_ext)
setattr(FinaAudit, 'prepare', prepare_ext)
setattr(FinaAudit, 'query_parameters', query_parameters_ext)
setattr(FinaAudit, 'param_loop_process', param_loop_process_ext)
