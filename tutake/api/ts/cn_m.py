...
from tutake.api.ts import cn_m_ext
...
class TushareCnM(TutakeTableBase):
...
class CnM(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareCnM),
