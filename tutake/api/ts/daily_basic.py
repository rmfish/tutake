...
from tutake.api.ts import daily_basic_ext
...
class TushareDailyBasic(TutakeTableBase):
...
class DailyBasic(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareDailyBasic),
...
extends_attr(DailyBasic, daily_basic_ext)
