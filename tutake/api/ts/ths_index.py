...
from tutake.api.ts import ths_index_ext
...
class TushareThsIndex(TutakeTableBase):
...
class ThsIndex(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareThsIndex),
...
extends_attr(ThsIndex, ths_index_ext)
