...
from tutake.api.ts import top_inst_ext
...
class TushareTopInst(TutakeTableBase):
...
class TopInst(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareTopInst),
...
extends_attr(TopInst, top_inst_ext)
