...
from tutake.api.ts import income_vip_ext
...
class TushareIncomeVip(TutakeTableBase):
...
class IncomeVip(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareIncomeVip),
...
extends_attr(IncomeVip, income_vip_ext)
