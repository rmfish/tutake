...
from tutake.api.ts.wz_index_ext import *
...
setattr(WzIndex, 'default_limit', default_limit_ext)
setattr(WzIndex, 'default_cron_express', default_cron_express_ext)
setattr(WzIndex, 'default_order_by', default_order_by_ext)
setattr(WzIndex, 'prepare', prepare_ext)
setattr(WzIndex, 'query_parameters', query_parameters_ext)
setattr(WzIndex, 'param_loop_process', param_loop_process_ext)
