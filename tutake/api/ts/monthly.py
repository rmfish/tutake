...
from tutake.api.ts import monthly_ext
...
class TushareMonthly(TutakeTableBase):
...
class Monthly(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareMonthly),
...
extends_attr(Monthly, monthly_ext)
