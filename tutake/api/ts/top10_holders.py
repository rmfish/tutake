...
from tutake.api.ts import top10_holders_ext
...
class Top10Holders(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareTop10Holders),
...
extends_attr(Top10Holders, top10_holders_ext)
