...
from tutake.api.ts import daily_ext
...
class TushareDaily(TutakeTableBase):
...
class Daily(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareDaily),
