...
from tutake.api.ts import fund_manager_ext
...
class FundManager(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareFundManager),
...
extends_attr(FundManager, fund_manager_ext)
