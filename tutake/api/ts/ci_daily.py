...
from tutake.api.ts.ci_daily_ext import *
...
setattr(CiDaily, 'default_limit', default_limit_ext)
setattr(CiDaily, 'default_cron_express', default_cron_express_ext)
setattr(CiDaily, 'default_order_by', default_order_by_ext)
setattr(CiDaily, 'prepare', prepare_ext)
setattr(CiDaily, 'query_parameters', query_parameters_ext)
setattr(CiDaily, 'param_loop_process', param_loop_process_ext)
