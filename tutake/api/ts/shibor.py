...
from tutake.api.ts import shibor_ext
...
class Shibor(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.writer = BatchWriter(self.engine, self.table_name, BaseDao.parquet_schema(TushareShibor),
...
extends_attr(Shibor, shibor_ext)
