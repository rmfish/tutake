...
from tutake.api.ts.margin_ext import *
...
class Margin(TushareDAO, TuShareBase, DataProcess):
    ...
    def __init__(self, config):
        ...
        self.schema = BaseDao.parquet_schema(TushareMargin)
...
setattr(Margin, 'default_limit', default_limit_ext)
setattr(Margin, 'default_cron_express', default_cron_express_ext)
setattr(Margin, 'default_order_by', default_order_by_ext)
setattr(Margin, 'prepare', prepare_ext)
setattr(Margin, 'query_parameters', query_parameters_ext)
