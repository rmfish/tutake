...
logger = logging.getLogger('api.tushare.ths_index')
...
class ThsIndex(BaseDao, TuShareBase, DataProcess):
    ...
    def fetch_and_append(self, **kwargs):
        ...
        def fetch_save(offset_val=0):
            ...
            logger.debug("Invoke pro.ths_index with args: {}".format(kwargs))
            res = self.tushare_api().ths_index(**kwargs, fields=self.entity_fields)
