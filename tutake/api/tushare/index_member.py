...
from tutake.api.tushare.extends.index_member_ext import *
...
logger = logging.getLogger('api.tushare.index_member')
...
class IndexMember(BaseDao, TuShareBase, DataProcess):
    ...
    def fetch_and_append(self, **kwargs):
        ...
        def fetch_save(offset_val=0):
            ...
            logger.debug("Invoke pro.index_member with args: {}".format(kwargs))
