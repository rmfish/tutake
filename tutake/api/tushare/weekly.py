...
engine = create_engine("%s/%s" % (tutake_config.get_data_sqlite_driver_url(), 'tushare_weekly.db'),
...
class Weekly(BaseDao, TuShareBase, DataProcess):
    ...
    def __init__(self):
        ...
        BaseDao.__init__(self, engine, session_factory, TushareWeekly, 'tushare_weekly', query_fields, entity_fields)
        DataProcess.__init__(self, "weekly")
        TuShareBase.__init__(self, "weekly")
        self.dao = DAO()
