...
from tutake.api.tushare.extends.index_dailybasic_ext import *
...
logger = logging.getLogger('api.tushare.index_dailybasic')
...
class IndexDailybasic(BaseDao, TuShareBase, DataProcess):
    ...
    def fetch_and_append(self, **kwargs):
        ...
        def fetch_save(offset_val=0):
            ...
            logger.debug("Invoke pro.index_dailybasic with args: {}".format(kwargs))
