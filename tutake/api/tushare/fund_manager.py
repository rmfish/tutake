...
from tutake.api.tushare.extends.fund_manager_ext import *
from tutake.api.tushare.tushare_base import TuShareBase
from tutake.utils.config import tutake_config

engine = create_engine("%s/%s" % (tutake_config.get_data_sqlite_driver_url(), 'tushare_fund_manager.db'),
...
TushareFundManager.__table__.create(bind=engine, checkfirst=True)
...
class FundManager(BaseDao, TuShareBase, DataProcess):
    ...
    def __init__(self):
        ...
        BaseDao.__init__(self, engine, session_factory, TushareFundManager, 'tushare_fund_manager', query_fields,
                         entity_fields)
        DataProcess.__init__(self, "fund_manager")
        TuShareBase.__init__(self, "fund_manager")
        self.dao = DAO()
    ...
    def fetch_and_append(self, **kwargs):
        ...
        def fetch_save(offset_val=0):
            ...
            res.to_sql('tushare_fund_manager', con=engine, if_exists='append', index=False, index_label=['ts_code'])
            return res
