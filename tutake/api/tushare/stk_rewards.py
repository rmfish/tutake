...
class StkRewards(BaseDao, TuShareBase, DataProcess):
    ...
    def __init__(self):
        ...
        self.entity_fields = ["ts_code", "ann_date", "end_date", "name", "title", "reward", "hold_vol"]
    ...
    def stk_rewards(self, fields='', **kwargs):
        ...
        if fields != '':
            entities = (
                getattr(TushareStkRewards, f.strip()) for f in fields.split(',') if f.strip() in self.entity_fields)
            ...
            def action(param):
                ...
                try:
                    ...
                    logger.info("[{}] Fetch and append {} data, cnt is {} . param is {}".format(
                        percent.format(), "stk_rewards", cnt, param))
    ...
    def fetch_and_append(self, process_type: ProcessType, **kwargs):
        ...
        def fetch_save(offset_val=0):
            ...
            res = pro.stk_rewards(**kwargs, fields=self.entity_fields)
