...
from tutake.api.tushare.extends.express_vip_ext import *
...
logger = logging.getLogger('api.tushare.express_vip')
...
class ExpressVip(BaseDao, TuShareBase, DataProcess):
    ...
    def fetch_and_append(self, **kwargs):
        ...
        def fetch_save(offset_val=0):
            ...
            logger.debug("Invoke pro.express_vip with args: {}".format(kwargs))
